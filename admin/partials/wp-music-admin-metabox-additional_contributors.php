...
$atts['class'] 			= 'widefat';
$atts['description'] 	= '';
$atts['id'] 			= 'additional_contributors';
$atts['label'] 			= 'Additional contributors';
$atts['name'] 			= 'additional_contributors';
$atts['placeholder'] 	= '';
$atts['type'] 			= 'text';
$atts['value'] 			= '';
...
$meta_value = $wpdb->get_var("SELECT additional_contributors FROM  $custom_table where post_id = $post_id ");
